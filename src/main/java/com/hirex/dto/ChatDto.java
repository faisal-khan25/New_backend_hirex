...
public class ChatDto {
    ...
    // Confirms the deletion to the requester only (never broadcast —
    // delete-for-me must stay invisible to the other participant).
    public static class DeleteForMeResponse {
        private Long messageId;
        private String deletedAt;

        public DeleteForMeResponse() {}

        public DeleteForMeResponse(Long messageId, String deletedAt) {
    ...
    // ── WebSocket event: delete for everyone ─────────────────────
    // Broadcast on /topic/chat/{applicationId} so every connected
    // participant updates the message tombstone in real time.
    public static class MessageDeletedEvent {
        private String type = "MESSAGE_DELETED_FOR_EVERYONE";
        private Long messageId;
        private Long applicationId;
        private Long deletedByUserId;
        private String deletedAt;
        private String placeholderText = "This message was deleted";

        public MessageDeletedEvent() {}

        public MessageDeletedEvent(Long messageId, Long applicationId, Long deletedByUserId, String deletedAt) {
            this.messageId = messageId;
